	...
	for aname in analysis_names:
		...
		for traj in trajfile:
					...
					if k == 1:
						...
						# Here we want to keep track of *pairs* not just single atoms.
                                                ...
                                                for i in which_ions_binding_two_lipids[0]:
                                                        ...
                                                        these_oxygens = ion_to_lipid_index_of_min[i][min_indices[0]],ion_to_lipid_index_of_min[i][min_indices[1]]
			...
			if interactive == 1:
				...
				plt.bar([i for i in range(len(oxygen_count))],[float(oxygen_count[i])/len(big_list) for i in range(len(oxygen_count))], align='center')
