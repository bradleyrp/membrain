...
newpkldir = './backup-2014.06.12-IET-revision-figs/backup-2014.06.12-IET-revision-stress/'
...
flatref = True		#---use a flat reference midplane instead of the rounded average structure
...
analysis_descriptors = {
	...
	'v614-s6part2': 
		{'sysname':'membrane-v614',
		'trajsel':'a5-stress-1.0-berendsen/md.part0002.rerun.trr',
		'nprots':4,
		'datdir3dpp':
			'/home/rpb/compbio/membrane-v614-enthx4-12800/a6-stress-1.0-framewise/results',
		'framewise_part':4},
	'v612-s6part2': 
		{'sysname':'membrane-v614',
		'trajsel':'s9-lonestar/md.part0004.120000-220000-200.xtc',
