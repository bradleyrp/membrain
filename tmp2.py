...
analysis_descriptors = [
	...
	['v550.part0008','pkl.structures.membrane-v550.md.part0008.shifted.pkl',
		'localpressure.v550.part0008.3Dpp.dat',0],
	['v614.part0002','pkl.structures.membrane-v614-stress.md.part0002.skip10.pkl',
		'localpressure.v614.part0002.3Dpp.dat',4]]
tests = [[3,32,16,1],
	[3,32,64,1],
	[3,32,20,1],
...
if batch_parameter_sweep_framewise:
	...
	pickle.dump(res_collection,open('/home/rpb/v614rescol','w'))
	'''
	if erase_when_finished:
		del mset
	fp = open(logfile+'.'+systemname,'w')
