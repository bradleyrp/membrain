...
tf_areas = []
starttime = time.time()
# 531-headspan-early 33-35 ns
# 531-headspan-late 62-67 ns
if 1:
...
if 1:
	ff_areas=unpickle(pickles+'pkl.headspan.v531.v532.part0010.25500-27500-4.pkl')
	fig = plt.figure()
	ax = plt.subplot(111)
	for sys in range(len(ff_areas)):
		hist0 = numpy.histogram(ff_areas[sys],bins=50)
		c = clrs[sys%len(clrs)]
